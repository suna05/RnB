            ...
            <div id="container-area">
                    <div id="board-nav">
                        <ul>
                        	<br>
                        	<br>
                            <li><a href="">SeachActor</a></li>
                            <li><a href="">SearchDirector</a></li>
                            <li><a href="">SearchWriter</a></li>
                        </ul>
                    </div>
                    <div id="contents">
                        ...
                        <div class="table-area">
                            <table>
                                <thead>
                                    <tr>
                                        <th scope="cols" width="100">No.</th>
                                        <th scope="cols" width="*">Contents</th>
                                        <th scope="cols" width="100">Category</th>
                                        <th scope="cols" width="120">Date</th>
                                        <th scope="cols" width="120">Name</th>
                                        <th scope="cols" width="80">Hits</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach var="board" items="${boardlist }">
                                        <tr>
                                            <td class="text-center" scope="row">${board.idx }</td>
                                            <td class="title">
                                                <a href="boardDetailView.do?idx=${board.idx }&commentPage=1">${board.btitle }</a>
                                            </td>
                                            <td class="text-center">${board.btype }</td>
                                            <td class="text-center">${board.bdate }</td>
                                            <td class="text-center">${board.writer }</td>
                                            <td class="text-center">${board.bcount }</td>
                                        </tr>                           
                                    </c:forEach>
                                </tbody>
                            </table>
