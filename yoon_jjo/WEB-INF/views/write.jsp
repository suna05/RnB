				...
				<tbody>
					<tr>
						...
						<td><input type="text" size="70" id="writeTitle"
							name="w_title" maxlength="250"></td>
					</tr>
					<tr>
						<td><br><br><br><br><br><br>내용</td>
						<td><textarea type="text" id="writeContent" name="w_content"></textarea>
						</td>
					</tr>
					<tr>
						<td>작성자</td>
						<td><c:choose>
								<c:when test="${sessionScope.member!=null}">
									<input type="text" size="20" id="writeWriter" name="w_writer"
