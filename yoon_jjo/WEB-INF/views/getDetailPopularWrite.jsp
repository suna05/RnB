		...
		<form name="form" method="post">
			<table border="1" style="width: 600px">
				...
				<tbody>
					<tr>
						<td>글 번호</td>
						<td>${getDetail.w_no}</td>
					</tr>
					<tr>
						<td>제목</td>
						<td>${getDetail.w_title}</td>
					</tr>
					<tr>
						<td>내용</td>
						<td><textarea type="text" size="70" id="writeContent"
							name="w_content" maxlength="250" disabled="disabled">${getDetail.w_content}</textarea>
						</td>
					</tr>
					<tr>
						<td>작성자</td>
						<td>${getDetail.w_writer}</td>
					</tr>
					<tr>
						<td>등록일</td>
						<td>${getDetail.w_date}</td>
					</tr>
					<tr>
						<td>조회수</td>
						<td>${getDetail.w_count}</td>
					</tr>

				</tbody>
			</table>

			<!-- <a href="index.do" class="btn btn-primary" id="list-btn">홈으로</a> -->
