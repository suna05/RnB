...
<body id="top">
	...
	<div id="main">
		...
		<!-- Two -->
		<section id="two">
					<caption>게시판 상세 읽기</caption>
<%-- 					<form action='update.do' method='POST'>
					<c:forEach items="${getDetailWrite}" var="write">
번호:<input type='text' name='w_no' value='${write.w_no}' readonly><br>
제목:<input type='text' name='w_title' value='${write.w_title}'><br>
작성자:<input type='text' name='w_content' value='${write.w_writer}'><br>
날짜:<input type='text' name='w_writer' value='${write.w_date}'><br>
조회수:<input type='text' name='w_count' value='${write.w_count}'><br>
</c:forEach> --%>
<table border="1" style="width: 600px">
					<caption>게시판 읽기</caption>
					
			<c:forEach items="${getDetailWrite}" var="write">
					번호:<input type='text' id="writeNo" name='w_no' value='${w_no}' readonly><br>
					...
					<tbody>
							<tr>
							<input type='text' name='no' value='${teacher.no}' readonly><br>
								<td> ${write.w_no}</td>
