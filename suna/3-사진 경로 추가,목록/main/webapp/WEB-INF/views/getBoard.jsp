<%@page import="com.web.rnb.writeimpl.WriteDAO"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@page import="com.web.rnb.write.*" %>
		...
		<section id="two">
			<div id="write">
				<table border="1" style="width: 600px">
					...
					<input name="writeNo" type="text" value= ${write.w_no} /> 
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <button type="button" class="btn btn-primary wirte-new" id="add-btn">추가</button>
