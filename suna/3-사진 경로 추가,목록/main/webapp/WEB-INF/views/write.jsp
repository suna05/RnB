...
<body id="top">
	...
	<div id="main">
		...
		<!-- Two -->
		<section id="two">
		<form action="insertWrite.do" method="post">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" size="70"
								id="writeTitle" name="w_title" maxlength="250"></td>
						</tr>
						<tr>
							<td>내용</td>
							<td><textarea type="text" 
								id="writeContent" name="w_content">
								</textarea></td>
						</tr>
						<tr>
							<td >작성자</td>
							<td><input type="text"  size="20"
								id="writeWriter" name="w_writer" maxlength="20"></td>
						</tr>
						<tr>
							<td>등록일</td>
							<td><input type="text" size="70" id="writeDate"
								name="w_date" maxlength="250">
							</td>
						</tr>
