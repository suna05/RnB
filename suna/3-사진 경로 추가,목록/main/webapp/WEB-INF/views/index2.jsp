									...
									<div class="form-group">
										<div class="col-sm-10 main-addr" style="width: 100%">
											<input class="form-control" type="text" name="m_address"
												id="addr" placeholder="근무지주소">
										</div>
									</div>
									<div class="modal-footer">
										<button id="add-btn" type="submit"
											class="form-control btn btn-primary"
											style="background-color: #787878; color: white;">가입</button>
									</div>
								</form>
							</div>
						</div>
									...
									<div class="form-group">
										<div class="col-sm-6" style="width: 100%">
											<input type="email" class="form-control"
												id="inputNick_change" placeholder="변경할 닉네임" value="닉네임">
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-6" style="width: 100%">
						...
						<div style="vertical-align: top; width: 100%;">
							<div style="text-align: center; padding-top: 3%;">
								<form action="login.do" class="form-horizontal" id="login-form"
									...
									<div class="form-group">
										<div class="col-sm-11 main-id" style="width:100%">
			  ...
			  //재입력 비밀번호 체크하여 가입버튼 비활성화 또는 맞지않음을 알림.
			    function checkPwd() {
			        ...
			        if(reinputed=="" && (inputed != reinputed || inputed == reinputed)){
			            $("#add-btn").prop("disabled", true);
			            $("#add-btn").css("background-color", "#aaaaaa");
			            $("#fi-password-check-add").css("background-color", "#FFCECE");
			        }
			        else if (inputed == reinputed) {
			            $("#fi-password-add").css("background-color", "#B0F6AC");
			            $("#fi-password-check-add").css("background-color", "#B0F6AC");
			            pwdCheck = 1;
			            if(idCheck==1 && pwdCheck == 1) {
			                $("#add-btn").prop("disabled", false);
			                $("#add-btn").css("background-color", "#4CAF50");
